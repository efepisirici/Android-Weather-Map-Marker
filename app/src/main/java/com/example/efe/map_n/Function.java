...
public class Function extends AppCompatActivity {
    ...
    private static final String OPEN_WEATHER_MAP_API = "60dbc877c16d5b8baf49c75af38ec342";
    ...
    public static JSONObject getWeatherJSON(String lng, String lat){
        try {
